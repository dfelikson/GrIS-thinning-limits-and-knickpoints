...
plt.hist(knickpoint_slopes[basin_categories == 1.], bins=bin_edges, density=False, facecolor=color1, edgecolor=color1, linewidth=1, alpha=0.25, histtype='stepfilled', label='gentle')
plt.hist(knickpoint_slopes[basin_categories == 0.], bins=bin_edges, density=False, facecolor=color2, edgecolor=color2, linewidth=1, alpha=0.25, histtype='stepfilled', label='mountainous')
